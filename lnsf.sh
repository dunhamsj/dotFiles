...
dir=${HOME}
sudo cp ${DOTFILES_DIR}/reboot.sh   /reboot.sh
sudo cp ${DOTFILES_DIR}/shutdown.sh /shutdown.sh
sudo ln -sf ${DOTFILES_DIR}/bash_aliases          ${dir}/.bash_aliases
sudo ln -sf ${DOTFILES_DIR}/bash_profile          ${dir}/.bash_profile
sudo ln -sf ${DOTFILES_DIR}/bashrc                ${dir}/.bashrc
sudo ln -sf ${DOTFILES_DIR}/bashrc.home.archlinux ${dir}/.bashrc.home.archlinux
sudo ln -sf ${DOTFILES_DIR}/bash_prompt           ${dir}/.bash_prompt
